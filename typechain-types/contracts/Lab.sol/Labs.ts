...
export interface LabsInterface extends utils.Interface {
  functions: {
    ...
    "setBuyBack(address)": FunctionFragment;
...
export interface Labs extends BaseContract {
