...
export interface MarketInterface extends utils.Interface {
  ...
  events: {
    "Adjust(uint256,uint256,uint256)": EventFragment;
    "AdjustOptionsChanged(uint32,uint32,uint32,uint32,uint32)": EventFragment;
    "Burn(address,uint256)": EventFragment;
    "Buy(address,address,uint256,uint256,uint256)": EventFragment;
    "FeeOptionsChanged(address,uint32,uint32)": EventFragment;
    "Lower(uint256,uint256)": EventFragment;
    "Paused(address)": EventFragment;
    "Raise(address,uint256,uint256)": EventFragment;
    "Realize(address,address,uint256,uint256)": EventFragment;
    "RoleAdminChanged(bytes32,bytes32,bytes32)": EventFragment;
    "RoleGranted(bytes32,address,address)": EventFragment;
    "RoleRevoked(bytes32,address,address)": EventFragment;
    "Sell(address,address,uint256,uint256,uint256)": EventFragment;
    "StablecoinsChanged(address,bool,bool)": EventFragment;
    "Unpaused(address)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "Adjust"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "AdjustOptionsChanged"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "Burn"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "Buy"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "FeeOptionsChanged"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "Lower"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "Paused"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "Raise"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "Realize"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "RoleAdminChanged"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "RoleGranted"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "RoleRevoked"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "Sell"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "StablecoinsChanged"): EventFragment;
...
export interface AdjustOptionsChangedEventObject {
  minTarget: number;
...
export type AdjustOptionsChangedEvent = TypedEvent<
  [number, number, number, number, number],
  AdjustOptionsChangedEventObject
>;

export type AdjustOptionsChangedEventFilter =
  TypedEventFilter<AdjustOptionsChangedEvent>;
...
export interface FeeOptionsChangedEventObject {
  dev: string;
  buyFee: number;
  sellFee: number;
}
export type FeeOptionsChangedEvent = TypedEvent<
  [string, number, number],
  FeeOptionsChangedEventObject
>;

export type FeeOptionsChangedEventFilter =
  TypedEventFilter<FeeOptionsChangedEvent>;

export interface LowerEventObject {
  target: BigNumber;
  targetAdjusted: BigNumber;
}
export type LowerEvent = TypedEvent<[BigNumber, BigNumber], LowerEventObject>;

export type LowerEventFilter = TypedEventFilter<LowerEvent>;
...
export interface RaiseEventObject {
  trigger: string;
  target: BigNumber;
  targetAdjusted: BigNumber;
}
export type RaiseEvent = TypedEvent<
  [string, BigNumber, BigNumber],
  RaiseEventObject
>;

export type RaiseEventFilter = TypedEventFilter<RaiseEvent>;

export interface RealizeEventObject {
  from: string;
  token: string;
  input: BigNumber;
  output: BigNumber;
}
export type RealizeEvent = TypedEvent<
  [string, string, BigNumber, BigNumber],
  RealizeEventObject
>;

export type RealizeEventFilter = TypedEventFilter<RealizeEvent>;
...
export interface StablecoinsChangedEventObject {
  token: string;
  buyOrSell: boolean;
  addOrDelete: boolean;
}
export type StablecoinsChangedEvent = TypedEvent<
  [string, boolean, boolean],
  StablecoinsChangedEventObject
>;

export type StablecoinsChangedEventFilter =
  TypedEventFilter<StablecoinsChangedEvent>;
...
export interface Market extends BaseContract {
  ...
  functions: {
    ...
    STARTUP_ROLE(overrides?: CallOverrides): Promise<[string]>;
  ...
  filters: {
    "Adjust(uint256,uint256,uint256)"(
      c?: null,
      f?: null,
      p?: null
    ): AdjustEventFilter;
    Adjust(c?: null, f?: null, p?: null): AdjustEventFilter;

    "AdjustOptionsChanged(uint32,uint32,uint32,uint32,uint32)"(
      minTarget?: null,
      maxTargetAdjusted?: null,
      raiseStep?: null,
      lowerStep?: null,
      lowerInterval?: null
    ): AdjustOptionsChangedEventFilter;
    AdjustOptionsChanged(
      minTarget?: null,
      maxTargetAdjusted?: null,
      raiseStep?: null,
      lowerStep?: null,
    ...
    "FeeOptionsChanged(address,uint32,uint32)"(
      dev?: null,
      buyFee?: null,
      sellFee?: null
    ): FeeOptionsChangedEventFilter;
    FeeOptionsChanged(
      dev?: null,
      buyFee?: null,
      sellFee?: null
    ...
    "Lower(uint256,uint256)"(
      target?: null,
      targetAdjusted?: null
    ): LowerEventFilter;
    Lower(target?: null, targetAdjusted?: null): LowerEventFilter;

    "Paused(address)"(account?: null): PausedEventFilter;
    Paused(account?: null): PausedEventFilter;

    "Raise(address,uint256,uint256)"(
      trigger?: null,
      target?: null,
      targetAdjusted?: null
    ): RaiseEventFilter;
    ...
    "Realize(address,address,uint256,uint256)"(
      from?: PromiseOrValue<string> | null,
      token?: PromiseOrValue<string> | null,
      input?: null,
      output?: null
    ...
    "StablecoinsChanged(address,bool,bool)"(
      token?: null,
      buyOrSell?: null,
      addOrDelete?: null
    ): StablecoinsChangedEventFilter;
    StablecoinsChanged(
      token?: null,
      buyOrSell?: null,
      addOrDelete?: null
  ...
  estimateGas: {
    ...
    STARTUP_ROLE(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    STARTUP_ROLE(overrides?: CallOverrides): Promise<PopulatedTransaction>;
